...
def translate_to_c(ast_dict):
    """ Simply use the c_generator module to emit a parsed AST.
    """
    generator = c_generator.CGenerator()
    print(generator.visit(ast_dict))
...
#         #translate_to_c(ast_dict)
#         # for i in ast_dict:
#         #     if i["_nodetype"] == "For":
#         #         left_cond = i["cond"]["left"]
#         #         op_cond = i["cond"]["op"]
#         #         right_cond = i["cond"]["right"]
#         #         lvalue_init = i["init"]["lvalue"]["name"]
#         #         op_init = i["init"]["op"]
#         #         rvalue_init = i["init"]["rvalue"]["value"]
#         #         next_name = i["next"]["expr"]["name"]
#         #         next_expr = i["next"]["op"]
#         #         stmt_lvalue_array = i["stmt"]["block_items"]["lvalue"]["name"]["name"]
#         #         stmr_lvalue_subscript = i["stmt"]["block_items"]["lvalue"]["subscript"]["name"]
#         #         stmt_operator = i["stmt"]["block_items"]["op"]
#         #         stmt_rvalue_left_array = i["stmt"][""]
